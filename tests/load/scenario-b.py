...
request1301 = createRequest(Test(1301, 'POST run'), url1)

request1401 = createRequest(Test(1401, 'OPTIONS e9e65040-7977-44d1-a0e4-a8f853f3a02b'), url1)

request1501 = createRequest(Test(1501, 'POST e9e65040-7977-44d1-a0e4-a8f853f3a02b'), url1)

request1601 = createRequest(Test(1601, 'GET sf-sightseeing.json'), url0)

request1701 = createRequest(Test(1701, 'POST e9e65040-7977-44d1-a0e4-a8f853f3a02b'), url1)

request1801 = createRequest(Test(1801, 'GET business-deliver.json'), url0)

request1901 = createRequest(Test(1901, 'POST e9e65040-7977-44d1-a0e4-a8f853f3a02b'), url1)
...
class TestRunner:
  ...
  def page1(self):
    ...
    request103.GET('/styles/main.css')

    request104.GET('/vendor/lodash/dist/lodash.min.js')

    request105.GET('/vendor/d3/d3.min.js')

    request106.GET('/vendor/backbone/backbone.js')

    request107.GET('/vendor/contour/dist/contour.min.js')

    grinder.sleep(63)
    request108.GET('/scripts/app.js')
  ...
  def page14(self):
    """OPTIONS e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1401)."""
    result = request1401.OPTIONS('/model/operation/e9e65040-7977-44d1-a0e4-a8f853f3a02b',
      '''0\r\n\r\n''')

    return result

  def page15(self):
    """POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1501)."""
    result = request1501.POST('/model/operation/e9e65040-7977-44d1-a0e4-a8f853f3a02b',
  ...
  def page16(self):
    ...
    result = request1601.GET('/data/sf-sightseeing.json')

    return result

  def page17(self):
    """POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1701)."""
    result = request1701.POST('/model/operation/e9e65040-7977-44d1-a0e4-a8f853f3a02b',
  ...
  def page18(self):
    ...
    result = request1801.GET('/data/business-deliver.json')

    return result

  def page19(self):
    """POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1901)."""
    result = request1901.POST('/model/operation/e9e65040-7977-44d1-a0e4-a8f853f3a02b',
  ...
  def __call__(self):
    ...
    grinder.sleep(111)
    self.page13()     # POST run (request 1301)

    grinder.sleep(114)
    self.page14()     # OPTIONS e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1401)

    grinder.sleep(124)
    self.page15()     # POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1501)

    grinder.sleep(38305)
    self.page16()     # GET sf-sightseeing.json (request 1601)

    grinder.sleep(2286)
    self.page17()     # POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1701)

    grinder.sleep(15556)
    self.page18()     # GET business-deliver.json (request 1801)

    grinder.sleep(3003)
    self.page19()     # POST e9e65040-7977-44d1-a0e4-a8f853f3a02b (request 1901)
